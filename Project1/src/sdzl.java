...
public class sdzl 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("La tempÃ©rature aujourd'hui est de " +temps);
		...
		while(rep == 'O')
		{
			...
			System.out.println("Votre nom fait: "+nom.length()+" caractÃ¨res.");
			System.out.println("Veuillez entrer votre age: ");
			int age = scan.nextInt();
			System.out.println("Votre Ã¢ge est: " + age);
			System.out.print("\n");
			System.out.println("En rÃ©sumÃ©, vous vous appelez " +nom);
			System.out.println("Et vous avez " + age);
			char tchar = nom.charAt(2);
		
			System.out.println("Le 3Ã¨me caractÃ¨re de votre nom est: "+tchar);	
			rep = ' ';
			do 
			{
				System.out.println("Voulez-vous reÌ�essayer ? (O/N)");
				scan.nextLine();
			...
			for(String sousTab[] : tabi)
			{
				...
				for(String str : sousTab)
				{
					...
					System.out.println("La valeur du tableau aÌ€ l'indice["+j+"]["+i+"] est : " + tabi[j][i]);
					i++; 
				}
			j++; 
			}
